...
class Grid:
    ...
    def add_to_grid(self, entity: Entity):
        ...
        if isinstance(entity, Tower):
            x1, x2 = (entity.position.x - entity.attack_range) / \
                self.radius, (entity.position.x + entity.attack_range) / self.radius
            y1, y2 = (entity.position.y - entity.attack_range) / \
                self.radius, (entity.position.y + entity.attack_range) / self.radius
